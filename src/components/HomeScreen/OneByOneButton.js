...
export default function OneByOneButton({ title, onPress, color = 'white', imageSource }) { // 기본값 'white'
    return (
...
const styles = StyleSheet.create({
    ...
    image: {
        ...
        right: 2,
        bottom: 2,
        width: adjustedWidth * (2 / 10), // 이미지 너비
        height: adjustedWidth * (2 / 10), // 이미지 높이
